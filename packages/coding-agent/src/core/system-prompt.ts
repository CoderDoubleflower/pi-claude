...
- Documentation may mention upstream Pi APIs; always use \`${APP_NAME}\` for CLI commands
...
- Always read relevant .md files completely and follow links to related docs (e.g., tui.md for TUI API details)`;
