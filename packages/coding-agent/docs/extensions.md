...
| Package | Purpose |
|---------|---------|
| `@doubleflower/pi-claude` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
...
```typescript
import { isToolCallEventType } from "@doubleflower/pi-claude";
...
```typescript
import { isBashToolResult } from "@doubleflower/pi-claude";
...
```typescript
import { createLocalBashOperations } from "@doubleflower/pi-claude";
...
```typescript
import { SessionManager } from "@doubleflower/pi-claude";
...
```typescript
import { withFileMutationQueue } from "@doubleflower/pi-claude";
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@doubleflower/pi-claude";
...
```typescript
import { createBashTool } from "@doubleflower/pi-claude";
...
```typescript
import { keyHint } from "@doubleflower/pi-claude";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@doubleflower/pi-claude";
