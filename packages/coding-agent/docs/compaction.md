...
For TypeScript definitions in your project, inspect `node_modules/@coderdoubleflower/pi-claude/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@coderdoubleflower/pi-claude";
