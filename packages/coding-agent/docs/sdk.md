...
```bash
npm install @coderdoubleflower/pi-claude
```
...
```typescript
import { createAgentSession, SessionManager } from "@coderdoubleflower/pi-claude";
...
import { ModelRuntime } from "@coderdoubleflower/pi-claude";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@coderdoubleflower/pi-claude";
...
```typescript
import { createAgentSession } from "@coderdoubleflower/pi-claude";
...
import { createAgentSession, defineTool } from "@coderdoubleflower/pi-claude";
...
```typescript
import type { InlineExtension } from "@coderdoubleflower/pi-claude";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@coderdoubleflower/pi-claude";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@coderdoubleflower/pi-claude";
